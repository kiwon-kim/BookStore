...
<body>
				...
				<div class="col-md-12">
					<div class="breadcrumbs">
						...
						<ul class="breadcrumbs-list">
							<li><a title="Return to Home" href="BookController">Home</a>
							</li>
						...
						<div class="tab-content">
							<div class="row tab-pane fade in active" id="home">
								<div class="shop-single-product-area">
									...
									<%--          									<a href="${path }/BookDeleteController?bookNum=${mvo.bookNum }">삭제</a> --%>
									<%-- 									</c:forEach> --%>
									<c:forEach items="${blist }" var="mvo">
											...
											<div class="single-banner">
												...
												<div class="banner-bottom text-center">
													<div class="banner-bottom-title">
														<a href="#">${mvo.bookName }</a> <input type="hidden"
															name="bookNum" value="${mvo.bookNum }">
													</div>
									...
									<c:forEach items="${blist }" var="mvo">
										...
										<div class="single-shop-product">
											<div class="col-xs-12 col-sm-5 col-md-4">
												<div class="left-item">
													<a href="${path }/single-product.do" title="자바의정석"> <img
														src="${path }${mvo.bookNum }" alt="">
											...
											<div class="col-xs-12 col-sm-7 col-md-8">
												<div class="deal-product-content">
													<h4>
														...
														<span class="new-price">$ ${mvo.bookNum }</span>
													</h4>
	...
	<!-- Nivo slider js -->
	<script src="${path }/lib/js/jquery.nivo.slider.js"
